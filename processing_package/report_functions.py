...
def generate_skeleton(process_state: dict):
    ''' 
    ...
    '''
    source_directory = process_state['raw_data_directory']
    steps = process_state['steps_list']
...
def initialize_next_step(state : dict) -> dict:
...
state = {'step_number' : 0, 
    ...
    steps_list = state['steps_list']
    next_step_number = state['step_number'] + 1

    next_step = steps_list[next_step_number]

    new_state['step_number'] = next_step_number
    new_state['step_name'] = next_step
    ...
    plot_save_dir = state['plots_dir'] / next_step
