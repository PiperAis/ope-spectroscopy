"""
Obsidian vault integration for TRR datasets.

- sync_report: copy a processed report folder into the vault
- generate_dataset_notes: write one .md note per processed .nc file,
  populated with frontmatter from the filename and the experiment note
"""
...
from .utilities import get_field, get_sample_name
